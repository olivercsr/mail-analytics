...
(defmethod store-report ((db postgres-storage) id report)
  ...
  (pg:execute (:insert-into 'reporter
               ...
               'reporter_id (s:report-reporter-id report)
               'error (s:report-error report)
               'policy_domain (s:report-policy-domain report)
               'policy_adkim (s:report-policy-adkim report)
               'policy_aspf (s:report-policy-aspf report)
               'policy_p (s:report-policy-p report)
               'policy_sp (s:report-policy-sp report)
               'policy_pct (s:report-policy-pct report)
               'policy_fo (s:report-policy-fo report)
