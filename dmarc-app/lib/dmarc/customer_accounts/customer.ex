defmodule Dmarc.CustomerAccounts.Customer do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Dmarc.Repo)
  ...
  """
  def valid_password?(%Dmarc.CustomerAccounts.Customer{hashed_password: hashed_password}, password)
