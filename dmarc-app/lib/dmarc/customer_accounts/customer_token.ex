defmodule Dmarc.CustomerAccounts.CustomerToken do
  use Ecto.Schema
  import Ecto.Query
  alias Dmarc.CustomerAccounts.CustomerToken
  ...
  schema "customers_tokens" do
    ...
    belongs_to :customer, Dmarc.CustomerAccounts.Customer
  ...
  """
  def by_customer_and_contexts_query(customer, :all) do
    from t in CustomerToken, where: t.customer_id == ^customer.id
  end

  def by_customer_and_contexts_query(customer, [_ | _] = contexts) do
