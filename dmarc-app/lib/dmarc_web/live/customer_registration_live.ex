defmodule DmarcWeb.CustomerRegistrationLive do
  ...
  def mount(_params, _session, socket) do
    changeset = CustomerAccounts.change_customer_registration(%Customer{})
  ...
  def handle_event("validate", %{"customer" => customer_params}, socket) do
    changeset = CustomerAccounts.change_customer_registration(%Customer{}, customer_params)
