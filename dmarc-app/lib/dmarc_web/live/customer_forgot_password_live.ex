defmodule DmarcWeb.CustomerForgotPasswordLive do
  ...
  def handle_event("send_email", %{"customer" => %{"email" => email}}, socket) do
    if customer = CustomerAccounts.get_customer_by_email(email) do
      CustomerAccounts.deliver_customer_reset_password_instructions(
        customer,
