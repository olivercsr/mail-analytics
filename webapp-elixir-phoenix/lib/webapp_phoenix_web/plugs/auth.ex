defmodule WebappPhoenixWeb.Plugs.Auth do
  import Plug.Conn
  require Config
  require Logger
  ...
  defp get_authuser_from_env() do
    (Application.get_env(:webapp_phoenix, :dev_authuser, "") || "") |> String.trim()
  end
  ...
  defp get_authuser(conn, authuser_header) do
    case Application.get_env(:webapp_phoenix, :env, :unknown) do
