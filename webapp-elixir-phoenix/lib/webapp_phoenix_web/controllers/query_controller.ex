defmodule WebappPhoenixWeb.QueryController do
  ...
  def count(conn, %{"start" => startts, "end" => endts} = _params) do
    ...
    existdb_config = Application.get_env(:webapp_phoenix, Util.ExistDb)
    case Util.ExistDb.query(existdb_config, "user123", "query_count", %{wantedBegin: startts_int, wantedEnd: endts_int}) do
